...
def go_to_url(context, url):
    ...
    web_component.go_to(context, url)
...
def verify_homepage_title(context, expected_title):
    ...
    :return:
    """
    web_component.assert_text(context.browser.title, expected_title)
...
def verify_url(context, expected_url):
    ...
    :return:
    """
    web_component.assert_text(context.browser.current_url, expected_url)